module.exports = ({name,Companyname,Ceoname}) =>{
...
<p id="cert-from" class="smaller">
  &nbsp; from www.${Companyname}.com
</p>

<br>
<p class="smaller" id='cert-issued'>
 <b>Issued on:</b>${`${today.getDate()}/ ${today.getMonth() + 1}/ ${today.getFullYear()}.`}
</p>
